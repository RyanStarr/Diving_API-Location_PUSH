...
def main():
    ...
    location_part_2 = [i.replace(',', ", 'lng': ") for i in location_part_1]
    location_part_3 = [a.replace('\"', '') for a in location_part_2]
    # for key, value in location_part_1.it
    print("GETTNG DATA")
    print(location_part_3)
    print(tempDataList[1])
    conversion = location_part_3
    print(conversion)
    print("GOT DATA")
